...
function generateFallbackPitch(lead) {
  ...
  if (isDeveloper) {
    subject = `سؤال لمطور مستقل: واش كتلف ليك الحسابات ودفعات الكليان فـ Excel؟ 💻`;
    body = `سلام ورجمة الله،

بصفتك مطور مستقل (Freelancer) فالمغرب، الوقت ديالك هو راس مالك. كل ساعة كتقضيها كتجرب تتبع شكون صيفط ليك الـ Avance، شكون باقي يسالك، وشحال ربحتي الحقيقي بعد ما حيدتي مصاريف السيرفرات، هي ساعة ضايعة من الكودينغ.

طورنا **Hisabi** (https://myhisabi.com) باش يحل ليك هاد المشكل تماماً:
1. **تتبع الـ Avances والمتبقي** ديال كل كليان ومشروع بلا ما تنسى حتى ريال.
2. **سجل المصاريف والمداخيل** واعرف صافي الربح الحقيقي ديالك أوتوماتيكياً.
3. **إدارة المشاريع والمهام والآجال** فبلاصة وحدة بلا تشتت جداول إكسيل.
